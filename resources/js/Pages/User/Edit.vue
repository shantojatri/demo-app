...
function updateUserHandler() {
    router.put(route("users.update", user.value.id), userParams, {
        onSuccess: () => toast.success("User updated successfully"),
    });
}

onMounted(() => {
    userParams.id = user.value.id;
    userParams.name = user.value.name;
    userParams.email = user.value.email;
    userParams.phone = user.value.phone;
    userParams.role = user.value.role;
    userParams.status = user.value.status;
})
</script>
