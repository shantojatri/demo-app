...
import { RiNotification2Line } from "@remixicon/vue";
    ...
    <nav
        ...
        <div class="flex flex-wrap justify-between items-center">
            ...
            <div class="flex items-center lg:order-2">
                ...
                <!-- Dropdown menu -->
                <div class="hidden z-50 my-4 w-52 text-base list-none bg-white rounded divide-y divide-gray-100 shadow md:rounded-xl"
                    id="dropdown">
                    <div class="py-3 px-4">
                    ...
                    <ul class="py-1 text-gray-700" aria-labelledby="dropdown">
                        <li>
                            ...
                            <RiUserLine class="mr-1" />
                            Profile
                            </Link>
                        </li>
                        <li>
                            <Link href="#" class="flex items-center py-2 px-4 text-sm hover:bg-gray-100">
                            <RiSettings5Line class="mr-1" />
                            Settings
                            </Link>
                        </li>
                    </ul>
                    ...
                    <ul class="py-1 text-gray-700" aria-labelledby="dropdown">
                        <li>
                            <Link :href="route('logout')" method="post" as="button"
                                class="flex justify-start w-full py-2 px-4 text-sm hover:bg-gray-100">
                            <RiLogoutBoxLine class="mr-1" />
                            Log Out
                            </Link>
                        </li>
                    </ul>
